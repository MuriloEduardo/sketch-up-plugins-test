...
Sketchup.require('me_vray_toolkit/mcp/tools/lighting')
Sketchup.require('me_vray_toolkit/mcp/tools/lights')
Sketchup.require('me_vray_toolkit/mcp/tools/materials')
Sketchup.require('me_vray_toolkit/mcp/tools/model')
Sketchup.require('me_vray_toolkit/mcp/tools/render')
Sketchup.require('me_vray_toolkit/mcp/tools/render_batch')
Sketchup.require('me_vray_toolkit/mcp/tools/render_settings')
Sketchup.require('me_vray_toolkit/mcp/tools/scenes')
Sketchup.require('me_vray_toolkit/mcp/tools/vision')
Sketchup.require('me_vray_toolkit/mcp/skills')
